...
<!-- """""""""""""""""""""""""""""""""""""""""""""""""""""""""SIDEBAR""""""""""""""""""""""""""""""""""""""""""""""""""""""""" -->
        <nav id="sidebar" class="active" style="
    min-width: 250px;
    max-width: 250px;
    background: #ffffff;
    color: #000;
...
">
            <div class="form-group">
              <input type="text" class="form-control" id="navbar-search-input" placeholder="Search" style="
    width: 326px;
">
            </div>
            <button type="button" class="" data-toggle="" aria-expanded="false" style="
    width: 69px;
">Search</button>
          </form>
